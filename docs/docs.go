...
const docTemplate = `{
    ...
    "info": {
        ...
        "contact": {
            "name": "API Support",
            "url": "https://github.com/ambiyansyah-risyal/go-base-app",
            "email": "support@example.com"
        },
        "license": {
            "name": "MIT",
            "url": "https://github.com/ambiyansyah-risyal/go-base-app/blob/main/LICENSE"
        },
        "version": "{{.Version}}"
    },
    "host": "{{.Host}}",
            ...
            "get": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        "type": "boolean",
                        "default": true,
                        "description": "Sort direction (true for desc)",
                        "name": "sort_desc",
                        "in": "query"
                    }
                ],
